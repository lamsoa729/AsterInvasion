...
time_point = float(sys.argv[1] if len(sys.argv) > 1 else len(filenames) - 1)
...
animationScene1.AnimationTime = float(time_point)
...
a3DText1 = a3DText(registrationName="20 um")
...
# Properties modified on a3DText1Display
a3DText1Display2.Scale = [3.0, 3.0, 3.0]

# Properties modified on a3DText1Display.DataAxesGrid
a3DText1Display2.DataAxesGrid.Scale = [3.0, 3.0, 3.0]

# Properties modified on a3DText1Display.PolarAxes
a3DText1Display2.PolarAxes.Scale = [3.0, 3.0, 3.0]

# Properties modified on a3DText1Display
a3DText1Display2.Origin = [11.5, 27.5, 0.0]
...
# Properties modified on a3DText1Display
a3DText1Display1.Scale = [3.0, 3.0, 3.0]

# Properties modified on a3DText1Display.DataAxesGrid
a3DText1Display1.DataAxesGrid.Scale = [3.0, 3.0, 3.0]

# Properties modified on a3DText1Display.PolarAxes
a3DText1Display1.PolarAxes.Scale = [3.0, 3.0, 3.0]

# Properties modified on a3DText1Display
a3DText1Display1.Origin = [11.5, 27.5, 0.0]
...
SaveScreenshot(
    str(data_path / (f"{data_path.stem}_t{time_point}.png")),
    layout1,
    SaveAllViews=1,
    ImageResolution=[width, height],
    FontScaling="Do not scale fonts",
